    ...
    <div className='bg-[#f3f5f9] py-[40px]'>
      <Container>
        <div>
          ...
          <div className='no-scrollbar gap-[20px]  pt-[2%] items-center justify-center  xl:grid xl:grid-cols-4 lg:grid lg:grid-cols-3 grid md:grid-cols-2 sm:grid sm:grid-cols-1 grid grid-cols-1'>
