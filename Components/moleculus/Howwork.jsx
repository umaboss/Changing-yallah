        ...
        <Container>
            ...
            <div className='pt-[4%]'>
                <div className=' gap-[50px] xl:grid xl:grid-cols-3 lg:grid lg:grid-cols-3 md:grid md:grid-cols-1 sm:grid sm:grid-cols-1 grid grid-cols-1'>
                    <div className='border-b-2 items-center flex xl:flex-row lg:flex-row md:flex-col sm:flex-col flex-col border-l-0 xl:border-l-0 xl:border-b-0 lg:border-l-0 lg:border-b-0 md:border-l-0 md:border-b-2 sm:border-l-0 sm:border-b-2'>
