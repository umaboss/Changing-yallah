    ...
    <div className="relative w-full h-[650px] overflow-hidden">
      ...
      >
        ...
        <div className="relative text-center mt-[50px] flex justify-center items-center flex-col w-[100%] z-10 text-white pt-[10%] px-[8%] p-8">
          ...
          />
          <Link href="/contactus" className="hover-fill-from-bottom cursor-pointer mt-[20px] bg-white leading-[30px] py-[11px] flex justify-center items-center xl:w-[17%] lg:w-[17%] md:w-[25%] sm:w-[30%] w-[60%]">
