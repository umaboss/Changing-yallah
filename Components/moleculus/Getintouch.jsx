       ...
       <div className='pt-[5%]'>
         <div className='bg-[#f3f5f9] py-[5%] '>
            <Container>
                   ...
                   <div className='bg-white flex flex-col items-center text-center gap-[20px] justify-center h-[200px] text-[#3787c3]  '>
                        <Link href='tel:00971 50 8786126'><IoCall className='items-center text-[40px]' /></Link>
                       <Link href='tel:00971 50 8786126' className='text-[22px] text-[#3787c3] cursor-pointer font-[500]'> 00971 50 8786126</Link>
                    </div>

                    <div className='bg-white flex flex-col items-center text-center gap-[20px] justify-center h-[200px] text-[#3787c3]'>
                       <Link href='mailto:waqaswqspk@gmail.com'> <IoMdMail  className='items-center text-[40px]' /></Link>
                        <Link href='mailto:waqaswqspk@gmail.com' className='text-[20px]'>waqaswqspk@gmail.com</Link>
                    </div>

                    <div className='bg-white flex flex-col items-center text-center gap-[20px] justify-center h-[200px] text-[#3787c3]'>
                        <Link href=''><IoLocation className='items-center text-[40px]' /></Link>
                        <Link href='' className='text-[22px] text-[#3787c3] cursor-pointer font-[500]' >Al Qouz, Dubai</Link>
                    </div>
                   </div>
