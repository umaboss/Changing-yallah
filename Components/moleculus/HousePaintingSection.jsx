    ...
    <Container>
      ...
      <div className=" gap-[10px]  text-[#3787c3]   xl:grid xl:grid-cols-3 lg:grid lg:grid-cols-3 md:grid md:grid-cols-2  sm:grid sm:grid-cols-1 grid grid-cols-1 ">
        {items.map((item) => (
          <div
            key={item.id}
            className="flex items-center justify-center    flex-col px-[20px] py-[50px] text-center  cursor-pointer border-black "
          >
            <img className="" src={item.image} alt="image"  />
            <h2 className="text-[#091736] text-[28px] font-[700] ">
              {item.title}
            </h2>
