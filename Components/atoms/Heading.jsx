import PropTypes from "prop-types";
  ...
  const getHeadingStyles = (level) => {
    switch (level) {
      case "1":
        return `xl:text-[60px] md:text-[50px] sm:text-[40px] text-[35px] text-[#091736] xl:font-[700] lg:font-[700] md:font-[700] sm:font-[600] font-[600] xl:leading-[70px] lg:leading-[60px] md:leading-[60px] sm:leading-[50px] leading-[40px] tracking-[-2px] ${className}`;
      case "2":
      ...
      case "4":
        return `text-[#091736] xl:text-[24px] lg:text-[24px] md:text-[20px] sm:text-[19px] text-[12px]  font-[500] leading-[1.3em] ${className}`;
      case "5":
